...
const Modal = (props) => {
  const { children, isOpen = false, openModal, FooterComponent, title } = props;
      ...
      >
        ...
        <div className="fixed top-28 right-0 left-0 z-10 overflow-y-auto md:top-44">
          <div className="flex min-h-full  justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="mr-4 block w-full transform  text-left text-base transition md:my-1 md:max-w-2xl md:px-4 lg:max-w-4xl">
